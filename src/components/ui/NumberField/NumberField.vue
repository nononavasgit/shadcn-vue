...
const rootProps = computed(() => {
  const rootUI = useUi(props.ui?.root, numberFieldContext.value)
...
const contentProps = computed(() => {
  const contentUI = useUi(props.ui?.content, numberFieldContext.value)
...
const decrementProps = computed(() => {
  const decrementUI = useUi(props.ui?.decrement, numberFieldContext.value)
...
const inputProps = computed(() => {
  const inputUI = useUi(props.ui?.input, numberFieldContext.value)
...
const incrementProps = computed(() => {
  const incrementUI = useUi(props.ui?.increment, numberFieldContext.value)
