...
const rootProps = computed(() => {
  const rootUI = useUi(props.ui?.root, popoverContext.value)
...
const triggerProps = computed(() => {
  const triggerUI = useUi(props.ui?.trigger, popoverContext.value)
...
const contentProps = computed(() => {
  const normalizedContentUI = useUi(props.ui?.content, popoverContext.value)
